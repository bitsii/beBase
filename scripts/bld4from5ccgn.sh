...
#time valgrind --tool=callgrind ./target5/BEX_E_gn.exe --buildFile build/buildbuild.txt --emitLang cc --singleCC true --saveIds false --deployPath deploy4 --buildPath target4
...
time g++ -o ./target4/BEX_E_gn.exe -Wfatal-errors -ggdb -std=c++11 ./target4/Base/target/cc/be/BEL_Base.cpp

...
#nondebug
time ./target5/BEX_E_cl.exe -cchImport=system/cc/be/BEH_SGCBEQ.hpp --buildFile build/buildbuild.txt --emitLang cc --singleCC true --saveIds false --deployPath deploy4 --buildPath target4 --emitFlag ccSgc
...
time clang++ -o ./target4/BEX_E_cl.exe -ferror-limit=1 -std=c++11 ./target4/Base/target/cc/be/BEL_Base.cpp

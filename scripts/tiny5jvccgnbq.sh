...
time java -XX:-UsePerfData -XX:TieredStopAtLevel=1 -XX:+UseSerialGC be.BEL_Base -deployPath=targets/tiny -buildPath=targets/tiny -cchImport=system/cc/be/BEH_SGCBEQ.hpp --emitFlag ccHs --buildFile build/tinyBase.txt --emitLang cc --singleCC true --emitFlag ccSgc --emitFlag ccNoRtti --emitFlag noSmap --emitFlag noRfl --emitFlag noBet --emitFlag bemdSmall --mainClass Test:TestHelloWorld ../beBase/source/baseTest/TestHelloWorld.be
...
time g++ $CPFLAGS -o targets/tiny/BEX_E_gn.exe ./targets/tiny/Base/target/cc/be/BEL_Base.cpp

...
mcs -debug:pdbonly -warn:0 -out:cycle/target1/BEL_4_Base_mcs.exe system/cs/abe/BELS_Base/*.cs cycle/target1/Base/target/cs/abe/BEL_4_Base/*.cs
...
mcs -debug:pdbonly -warn:0 -out:cycle/target2/BEL_4_Base_mcs.exe system/cs/abe/BELS_Base/*.cs cycle/target2/Base/target/cs/abe/BEL_4_Base/*.cs
...
mcs -debug:pdbonly -warn:0 -out:cycle/targetEc/BEL_4_Base_mcs.exe system/cs/abe/BELS_Base/*.cs cycle/targetEc/Base/target/cs/abe/BEL_4_Base/*.cs

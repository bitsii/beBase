...
void** bevl_mcall;
      ...
      if (undef(args)) {
         throw(System:InvocationException.new("invocation argument Array is null"));
      }
      numargs = args.length;
      ...
      ifEmit(jv,cs) {
        if (numargs > 7) { 
            Array args2 = Array.new(numargs - 7); 
      ...
      if (tf != null) {
        ...
        bevl_rval = tf.apply(this, beva_args.bevi_array);
      } else {

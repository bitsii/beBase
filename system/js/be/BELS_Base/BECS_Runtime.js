    ...
    if (null != theThrow) {
        if (theThrow instanceof be_BELS_Base_BECS_ThrowBack) {
          ...
          if (null != theThrow.thrown &&
              theThrow.thrown instanceof be_BEL_4_Base_BEC_2_6_9_SystemException) {
              var bes = theThrow.thrown;
              bes.bem_langSet_1(
                 new be_BEL_4_Base_BEC_2_4_6_TextString().beml_set_bevi_bytes(bes.bems_stringToBytes_1("js"))
                 );
              bes.bem_framesTextSet_1(new be_BEL_4_Base_BEC_2_4_6_TextString().beml_set_bevi_bytes(bes.bems_stringToBytes_1(theThrow.error.stack)));
              return bes;
          } else {
